...
class CafesSeeder extends Seeder
{
    ...
    public function run()
    {
     ...
     /*2*/ DB::table("cafes")->insert(
        ...
        /*3*/ DB::table("cafes")->insert(
           ["nome"=>"Café Ristretto","descricao"=>"O ristretto é uma versão mais concentrada do café espresso padrão. Entre os tipos de café mais populares, é o que apresenta maior intensidade. Basicamente, trata-se da extração da mesma quantidade de café de um espresso, mas em apenas metade da quantidade de água.
        ...
        /*4*/ DB::table("cafes")->insert(
           ["nome"=>"Café Latte","descricao"=>"O Café Latte não é exatamente uma forma sofisticada de se tratar do café com leite. Em sua receita original, utiliza-se leite vaporizado misturado a uma dose de café espresso, além de 1 centímetro de espuma de leite servido sobre a bebida.
...
Diferencia-se de um Machiatto especialmente no que diz respeito à proporção e à forma como é servido. No Machiatto, as três camadas são servidas sem estarem misturadas dentro da xícara. Já no Latte, o café e o leite vaporizado são misturados, com a espuma servida sobre a mistura, separadamente."]
         ...
         /*5*/ DB::table("cafes")->insert(
           ["nome"=>"Cappuccino","descricao"=>"O Cappuccino é bastante parecido com um Latte, e é um dos tipos de café mais populares em cafeterias e bares ao redor do mundo. A diferença entre os dois está no fato de o cappuccino possuir mais leite vaporizado em sua fórmula, além de chocolate adicionado à receita.
